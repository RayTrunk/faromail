/* FARO Mail — liste virtuelle de messages */
'use strict';
// FARO Mail 0.2.25 v2 — restauration complète des conversations
class VirtualMailList {
  ...
  renderRow(row, top) {
    ...
    // FARO Mail 0.2.24 UI v18 — la flèche est une vraie bascule.
