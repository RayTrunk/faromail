/* FARO Mail 0.3.2 — planning local, vues multiples et import */
'use strict';
(function () {
  ...
  function plannerPaneCollapsed() {
    const value = localStorage.getItem('faromail.plannerPaneCollapsed');
    // Reprend l'ancienne préférence enregistrée avant le renommage
    // LibraMail -> FARO Mail si elle n'a pas encore été réécrite.
    if (value === null) return localStorage.getItem('libramail.plannerPaneCollapsed') === '1';
    return value === '1';
  }
  ...
  function setPlannerPaneCollapsed(collapsed) {
    ...
    localStorage.setItem('faromail.plannerPaneCollapsed', value ? '1' : '0');
