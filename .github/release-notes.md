...
FARO Mail 0.4.3 is a corrective release that restores drag-and-drop attachment handling in the message composer.

### Fixes

- Fixed file drag-and-drop in new messages and replies.
- Dropped files are now added as real email attachments.
- Dropping a PDF no longer opens it directly inside FARO Mail.
