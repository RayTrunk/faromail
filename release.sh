...
VERSION="${1#v}"
NOTES_FR="${2:-Améliorations et corrections de FARO Mail.}"
NOTES_EN="${3:-FARO Mail improvements and fixes.}"
TAG="v$VERSION"
...
git commit -m "Release FARO Mail $VERSION"
git tag -a "$TAG" -m "FARO Mail $VERSION"
