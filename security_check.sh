...
patterns='(^|/)(data/(accounts\.json|config\.json|index\.db|mail/)|backups/|node_modules/|build/|dist/|\.cache/)|\.(eml|mbox|pst|pfx|p12|pem|key|db|sqlite)(-|$)|\.(faromail|libramail)-backup\.zip$'
